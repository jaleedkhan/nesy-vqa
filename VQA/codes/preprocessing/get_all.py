...
class InstanceList():
    ...
    def postprocess(ret, dict_dir):
        ...
        official_split_index = json.load(open(os.path.join(dict_dir, 'split_index_updated.json')))
...
def copy_question(question_path_dir):
    ...
    # question tiers
    for tier in ['train_balanced', 'val_balanced','test_balanced']:
        ...
        json.dump(demo_qs_dict, open("demo_qs_qid.json", 'w'))

##changed official_split_index to split_index_updated in this .py file
if __name__=='__main__':
    input_dir = 'graphs'
    dict_dir = '../../../data/dicts'
    for f in ['split_index_updated.json', 'question_vocab.json', 'answer_set.json']:
