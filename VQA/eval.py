...
parser.add_argument('--scenes',         default="val_sceneGraphs.json",   type = str,    help = "Scene graphs file name format.")
parser.add_argument('--questions',      default="val_balanced_query.json", type = str,    help = "Questions file name format.")
parser.add_argument('--choices',        default="val_choices.json",       type = str,    help = "Choices file name format.")
parser.add_argument('--predictions',    default="pred_balanced_query.json",   type = str,    help = "Answers file name format.")
parser.add_argument('--grounding',      action="store_true",        help = "True to compute grounding score (If model uses attention).")
parser.add_argument('--consistency',  default= True,  action="store_true",        help = "True to compute consistency score (Need to provide answers to questions in val_all_questions.json).")
...
def updateConsistency(questionId, question, questions):
    ...
    ## picked this fun from https://github.com/codexxxl/GraphVQA/blob/master/eval.py
